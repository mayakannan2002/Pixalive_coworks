...
import bgImage from './../../src/assets/home/herobg1.png'; // Background image path
import logo from './../../src/assets/home/plogo.png'; // Logo path
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex justify-between items-center py-4 max-w-[1280px] px-4 md:px-12 mx-auto">
        ...
        <Link to="/contact">
          <button className="group bg-white text-black font-black text-lg px-4 py-2 transition hover:bg-gray-200 whitespace-nowrap">
            Let's talk
      ...
      {/* Main Content */}
      <div className="relative z-10 max-w-[1280px] mx-auto px-4 md:px-12 mt-20 sm:mt-24">
        ...
        {/* Buttons Container */}
        <div className="mt-7 sm:mt-10 flex flex-col sm:flex-row sm:justify-start sm:items-center gap-4 sm:gap-6">
          {/* Book a Space Button */}
          <Link to="/contact">
            <button className="group bg-white text-black px-4 py-2 text-lg font-semibold hover:bg-gray-200 transition duration-300 cursor-pointer w-full sm:w-auto whitespace-nowrap">
              Book a Space

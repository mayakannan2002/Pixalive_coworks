...
export default function TestimonialSlider() {
  ...
  return (
    <section className="py-14 px-4 md:px-12 flex flex-col items-center justify-center">
      {/* Header Section */}
      <div className="max-w-[1280px] w-full flex flex-col md:flex-row gap-12 mb-10">
        ...
        <div className="md:w-2/2 max-w-[500px]">
          <p className="text-xl md:text-[28px] font-semibold text-black leading-relaxed">
            Our members say it best. Dive into their experiences and discover why Pixalive
            isn’t just a co-working space — it’s a thriving community.
          </p>
        </div>
      </div>
      ...
      <div
        ref={containerRef}
        className="flex gap-6 overflow-x-scroll scroll-smooth scrollbar-hide w-full max-w-[1280px]"
